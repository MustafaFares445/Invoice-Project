...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبا بك مجدداّ</h2>
        ...
        <div class="main-dashboard-header-right">
            ...
            <div>
                <label class="tx-13">المبيعات عن طريق الانترنت</label>
                <h5>563,275</h5>
            </div>
            <div>
                <label class="tx-13">المبيعات المحلية</label>
                <h5>783,675</h5>
            </div>
        </div>
    </div>
